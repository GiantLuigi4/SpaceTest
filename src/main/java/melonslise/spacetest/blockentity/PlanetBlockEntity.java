...
public class PlanetBlockEntity extends BlockEntity
{
	...
	{
		this.planetProps = new BasicPlanetProperties(new Vector3d(pos.getX() + 0.5d, pos.getY() + 0.5d, pos.getZ() + 0.5d), ChunkSectionPos.from(pos.withY(placer.world.getBottomY())), 4, 62 - placer.world.getBottomY());
